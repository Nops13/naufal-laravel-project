        ...
        @section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h1 class="text-white"><b> Kerugian </b></h1>
                        <p class="text-white"> Menampilkan Laporan Data kerusakan pada kendaraan.
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
