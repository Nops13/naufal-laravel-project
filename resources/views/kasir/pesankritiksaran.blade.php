...
<head>
    ...
    <title> Pesan kritik dan Saran</title>
</head>
        ...
        @section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h1 class="text-white"><b> Pesan Kritik dan Saran dari Owner </b></h1>
                        <p class="text-white"> Kritik dan saran dari owner apabila disuruh melakukan pembersihan kandang
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-end">
                                            <div class="col-md-8 offset-md-3">
                                                <a href="peternak" class="btn btn-primary">
                                                    {{ __('kembali') }}
                                                </a>
                                            </div>
