            ...
            <div class="row justify-content-center mb-5">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url(baru/images/bg-3.jpg);">
                        </div>
                        <div class="login-wrap p-4 p-md-5">
                            <div class="d-flex">
                                <div class="w-100">

                                    <h3 class="mb-4">Daftar Akun Rental Mobil.Id</h3>
                                </div>
                                {{-- <div class="w-100">
                            ...
                            <form action="{{ route('register.post') }}" method="POST" class="signin-form">
                                ...
                                <a href="/" class="form-control btn btn-primary rounded submit px-3">Masuk</a>
                            ...
                            {{-- <p class="text-center">Not a member? <a data-toggle="tab" href="/registration">Sign
                                    Up</a></p> --}}
                        </div>
                    </div>
                </div>
