...
<head>
    ...
    <title>Monitoring Pembelian Obat Ayam</title>
</head>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="monitoring_pemberian_obat_ayam" class="btn btn-primary">
                                {{ __('Pemberian Pakan') }}
                            </a>
                        ...
                        <h1 class="text-white"><b> Monitoring Pembelian Obat </b></h1>
                        <p class="text-white"> Data dari hasil input Pembelian Obat Ayam yang telah diisi peternak
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
