...
<head>
    ...
    <title>Monitoring Pemberian Obat Ayam</title>
</head>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <a href="monitoring_pembelian_obat_ayam" type="submit" class="btn btn-success">
                                {{ __('Pembelian Obat') }}
                            </a>
                        </div>
                        <h1 class="text-white"><b> Monitoring Pemberian Obat </b></h1>
                        <p class="text-white"> Data dari hasil input Pemberian Obat Ayam yang telah diisi peternak
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
