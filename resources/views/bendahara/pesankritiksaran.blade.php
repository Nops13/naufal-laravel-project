        ...
        @section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h1 class="text-white"><b> Pesan Kritik dan Saran dari Peternak </b></h1>
                        <p class="text-white"> Kritik dan saran dari peternak apabila segera membutuhkan supply pakan dan
                            obat
                        </p>
                    </div>
                </div>
