...
<head>
    ...
    <title>Monitoring Pemberian Pakan Ayam</title>
</head>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <a href="monitoring_pembelian_pakan_ayam" type="submit" class="btn btn-success">
                                {{ __('Pembelian Pakan') }}
                            </a>
                        </div>
                        <h1 class="text-white"><b> Monitoring Pemberian Pakan </b></h1>
                        <p class="text-white">Data dari hasil input Pemberian Pakan Ayam yang telah diisi peternak
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Jumlah Pemberian</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
