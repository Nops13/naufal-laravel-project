...
@section('content')
    ...
    <section class="proses" id="proses">
        <h3>Fitur Bendahara</h3>
        <div class="container">

            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="datapengeluaran/create" class="profile">
                            <img src="image/pengeluaran.png">
                        </a>
                        <div>
                            <p><b>Data pengeluaran</b></p>
                            <p>Data Pengeluaran.
                            </p>
                        </div>
                    </div>
            ...
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="laporan" class="profile">
                            <img src="image/laporan.png">
                        </a>
                        <div>
                            <p><b>Laporan Keuangan</b></p>
                            <p>Laporan Keuangan bulanan
                            </p>
                        </div>
                    </div>
                </div>
