...
<head>
    ...
    <title>Monitoring Stock Nutrisi</title>
</head>
        ...
        @section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h1 class="text-white"><b> Monitoring Stock Nutrisi </b></h1>
                        <p class="text-white"> Data dari hasil inputan pembelian, pemberian pakan dan obat
                        </p>
                    </div>
                </div>
                <div class="row justify-content-center">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">ID</th>
                                                <th scope="col">Nama Pakan/Obat</th>
                                                <th scope="col">Jenis Pakan/Obat</th>
