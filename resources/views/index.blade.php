    ...
    <section class="proses" id="proses">
        ...
        <div class="container">
            ...
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="transaksi_penyewaan/create" class="profile">
                            <img src="image/Transaksi.png">
                        </a>
                        <div>
                            <p><b>Transaksi Penyewaan</b></p>
                            <p>Mencatat transaksi keluar dan masuknya mobil sewa.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="member/create" class="profile">
                            <img src="image/Membermek.png">
                        </a>
                        <div>
                            <p><b>Data Member</b></p>
                            <p>Pendataan member penyewaan mobil
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="pengembalian/create" class="profile">
                            <img src="image/Pengembalian.png">
                        </a>
                        <div>
                            <p><b>Pendataan Pengembalian</b></p>
                            <p>Data pengembalian mobil yang telah di sewa oleh penyewa, serta untuk melakukan pembayaran
                                sewa.
                            </p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="kerugian/create" class="profile">
                            <img src="image/Gantirugi.png">
                        </a>
                        <div>
                            <p><b>Data kerusakan</b></p>
                            <p>Pendataan Kerusakan pada kendaraan sewa
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="hero">
                <div class="review-box">
                    <div class="card">
                        <a href="transaksi_penyewaan" class="profile">
                            <img src="image/nota.png">
                        </a>
                        <div>
                            <p><b>Nota Transaksi</b></p>
                            <p>Pencetakan Nota dari transaksi yang telah dilakukan oleh kasir dan penyewa.
                            </p>
                        </div>
                    </div>
                </div>
