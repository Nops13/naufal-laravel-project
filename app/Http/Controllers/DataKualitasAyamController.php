...
use App\Models\DataKualitasAyam;
use Illuminate\Http\Request;

class DataKualitasAyamController extends Controller
{

     public function index()
    {
        $monitoring_ayams = DataKualitasAyam::all(); //mengembalikan collection
    ...
    //     return redirect()->route('AyamMasuk.index');
